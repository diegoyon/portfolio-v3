const ProjectsData = [
  ...
  // },
  {
    ...
    description:
      "Website that displays information about a CrossFit competition. It let the users know more about the competition, its workouts and the athletes' leaderboard. Built with React.",
    skills: ['React'],
  },
  {
    title: 'Crypto App',
  ...
  // },
  {
    ...
    description:
      'A web application based on an external API which contains information about TV shows. th web app let you like the shows that you like the most and comment what you think about them making use of an involvement API to save this interaction information.',
